...
/****** Déclaration des constantes variable et objets ******/
...
SoftwareSerial LoraE5(A0, A1);    				// on ouvre une 2ème com série sur A0 A1 
												                  // (on y branche le loraE RX TX)
...
void setup(void) {
  ...
  // Fréquence, mode, bande passante, puissance RX, puissance TX, CRC (contrôle le nombre de byte envoyés/reçus), 
  // IQ (inversé), réseau public/privé (off/on)   
